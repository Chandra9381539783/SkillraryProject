...
/*
	...
	public class WebDriverUtility {
		...
		/**
		 * This method is used to drag and drop the element to target
		 * @param element
		 * @param target
		 */
		...
		/**
		 * This method is used to select an element from drop and down using visible text
		 * @param text
		 * @param element
		 */
		...
		/**
		 * This method is used switch to frame using id or name attribute value
		 * @param idOrName
		 */
		 ...
		 * @param frameElement
		 */
		public void swtichToFrame(WebElement frameElement) {
			driver.switchTo().frame(frameElement);
		}
		/**
		 * This method is used to switch back from frame
		 */
		public void swtichBackFromFrame() {
			driver.switchTo().defaultContent();
		 }

		/**
		 * This method is used to capture screenshot os window
		 * @param jUtil
		 */
